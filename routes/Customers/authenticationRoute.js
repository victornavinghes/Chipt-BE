...
router.route('/signup').post(
    customerAuthentication.projectName_Customer_Account_Sign_Up
);

// 02) CUSTOMER: OTP verification
router.route('/otp/verification').put(
...
router.route('/signin').post(
    customerAuthentication.projectName_Customer_Account_Sign_In
);
...
router.route('/contact/update').put(
    authToken.isUserAuthenticated,  
    authToken.userAuthorizedRole(['customer', 'customer']),
    authToken.userDataClear,
...
router.route('/basic/info/update').put(
    authToken.isUserAuthenticated,  
    authToken.userAuthorizedRole(['customer', 'customer']),
    authToken.userDataClear,
...
router.route('/profile/image').get(
    authToken.isUserAuthenticated,  
    authToken.userAuthorizedRole(['customer', 'customer']),
    authToken.userDataClear,
